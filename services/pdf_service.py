...
class PDFService:
    ...
    def _create_summary_stats(self, project: Dict[str, Any]) -> List:
        ...
        • <b>Generated by:</b> LeadFinder AI Platform<br/>
        ...
        • <b>Quality Assurance:</b> Automated relevance scoring with manual review capabilities
        """
    ...
    def _create_custom_title_page(self, project: Dict[str, Any], company_name: str, disclaimer: str) -> List:
        """Create custom title page with company branding"""
        story = []
        ...
        # Disclaimer
        disclaimer_para = Paragraph(f"<i>{disclaimer}</i>", self.styles['CustomBody'])
    ...
    def _create_company_footer(self, company_name: str, disclaimer: str) -> List:
        ...
        This report contains proprietary information and should be treated as confidential.
        """
